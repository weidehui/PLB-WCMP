...
def parse (fileName):
    ...
    #Dehui
    print "Total Tx Bytes: %i" % total_txBytes
    print "Avg Througput: %.4f" % (total_txBytes / total_fct)

    return {'avg_fct': avg_fct, 'avg_small_fct': avg_small_fct, 'avg_large_fct': avg_large_fct, 'small_flow_99': small_flow_fct_99, 'flow_99' : flow_fct_99, 'total_tx' : total_packets, 'total_rx' : total_rx_packets, 'flow_count' : flow_count,'total_txBytes' : total_txBytes,'avg_throughput' : avg_throughput}
